...
export TYPEORM_ENTITIES="${TYPEORM_ENTITIES:-dist/entities/*.js}"
export TYPEORM_MIGRATIONS="${TYPEORM_MIGRATIONS:-dist/migrations/*.js}"
export TYPEORM_MIGRATIONS_DIR="${TYPEORM_MIGRATIONS_DIR:-src/migrations}"
